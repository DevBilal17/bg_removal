...
const Hero = () => {
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 lg:px-44 mt-10 sm:mt-20'>
      {/* ---- Left Side ---- */}
      <div>
         <h1
         ...
         <div>
            ...
            <label htmlFor="upload1" className='inline-flex gap-3 px-8 py-3.5 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700'>
